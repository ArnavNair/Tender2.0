...
contract Tender{
    ...
    */
    ...
    function getBidSummary(uint index) public returns (address, uint, string) {
        return (
            bids[index].bidder,
    ...
    */
    ...
    function getSummary() public returns (address, string, uint) {
        return(manager,
        data,
        bids.length);
    }
    ...
    function verifyManager() public returns (bool) {
